...
go
alter table Manage add foreign key (TypeSN) references ProblemType(SN) on delete no action on update cascade
--商店
create table Stores(
SN INT IDENTITY(1,1) primary key,
...
ALTER TABLE Admin ADD Title nvarchar(20)
ALTER TABLE Admin Alter COLUMN Extension nvarchar(10) 
